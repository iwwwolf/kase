					...
					var t = function () {
						...
						function () {
							...
							if (c.sundayFirst) {
								...
								for (b = 1; b <= z; b++) a = moment(d).date(b).format("D.M.YYYY") === u.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_current" id="test">' + b + "</td>") : g && moment(d).date(b).format("D.M.YYYY") === g.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_selected">' + b + "</td>") : a + ('<td class="ic__day">' + b + "</td>"), (k + b) / 7 === Math.floor((k + b) / 7) && (a += "</tr><tr>");
								b = p
							} else {
								a += '<table class="ic__week-head"><tr>';
								...
								for (b = 1; b <= z; b++) a = moment(d).date(b).format("D.M.YYYY") === u.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_current" data-day="'+moment(d).date(b).format("DD.MM.YYYY")+'">' + b + "</td>") : g && moment(d).date(b).format("D.M.YYYY") === g.format("D.M.YYYY") ? a + ('<td class="ic__day ic__day_state_selected">' + b + "</td>") : a + ('<td class="ic__day" data-day="'+moment(d).date(b).format("DD.MM.YYYY")+'">' + b + "</td>"), (k + b) / 7 === Math.floor((k + b) / 7) && (a += "</tr><tr>");
								1 > p && (p = 7);
								b = p - 1;
							}
