...
! function (a, b) {
	...
	var Vd = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
		Wd = "Январь_Февраль_Март_Апрель_Май_Июнь_Июль_Август_Сентябрь_Октябрь_Ноябрь_Декабрь".split("_"),
		Xd = "Янв_Фев_Мар_Апр_Май_Июн_Июл_Авг_Сен_Окт_Ноя_Дек".split("_"),
		Yd = Jd,
		Zd = Jd,
	...
	var qe = "Воскресенье_Понедельник_Вторник_Среда_Четверг_Пятница_Суббота".split("_"),
		re = "Вскр_Пон_Втр_Ср_Чтв_Пт_Сбт".split("_"),
		se = "Вс_Пн_Вт_Ср_Чт_Пт_Сб".split("_"),
		te = Jd,
		ue = Jd,
		ve = Jd;
